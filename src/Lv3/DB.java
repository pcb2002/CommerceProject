...
public class DB {
    ...
    // 상품 리스트 초기화
    private List<Product> electronicList = List.of(
    ...
    // 2. 카테고리 생성
    private Category electronicsCategory = new Category("전자제품", electronicList);
    private Category clothingCategory = new Category("의류", clothingList);
    private Category foodCategory = new Category("식품", foodList);
